          ...
          <div className="p-1 sm:p-2 flex justify-between items-center border-b border-button">
                ...
                <div className="flex items-center">
                  ...
                  {!openForCart && (
                    <p className="text-sm sm:text-base">
                      <span className="font-bold px-2">=</span> {item.price}
                    </p>
                  )}
                </div>
                {openForCart && (
                  <p className="text-sm sm:text-base mt-2 font-semibold text-green-500">
                    In Stock
                  </p>
                )}
              </div>
            ...
            {openForCart && (
              <div className="flex items-center pl-2 sm:pl-4">
                <p className="text-sm sm:text-base pr-2 sm:pr-4">
                  {item.price}
                </p>
